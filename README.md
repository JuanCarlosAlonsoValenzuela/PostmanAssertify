...
This CSV file is not expected to be generated manually; it should be generated by [*AGORA*](https://github.com/isa-group/Beet). Please, take into account that the `postmanAssertion` column is only implemented for the 105 Daikon invariants supported by AGORA.
