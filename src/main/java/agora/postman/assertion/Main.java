...
public class Main {
    ...
    private static String openApiSpecPath = "src/test/resources/inputParametersScriptGeneration/test_005/oas_path_parameters_array_primitive.yaml";

    private static String invariantsPath = "src/test/resources/inputParametersScriptGeneration/test_005/invariants_test_005.csv";
