...
public class Main {
    ...
    private static String openApiSpecPath = "src/test/resources/inputParametersScriptGeneration/test_004/oas_query_parameters_primitive.yaml";

    private static String invariantsPath = "src/test/resources/inputParametersScriptGeneration/test_004/invariants_test_004.csv";
