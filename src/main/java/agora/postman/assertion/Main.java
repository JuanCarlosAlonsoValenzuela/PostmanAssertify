...
public class Main {
    ...
    private static String openApiSpecPath = "src/test/resources/inputParametersScriptGeneration/test_006/oas_header_parameters_array_primitive.yaml";

    private static String invariantsPath = "src/test/resources/inputParametersScriptGeneration/test_006/invariants_test_006.csv";
