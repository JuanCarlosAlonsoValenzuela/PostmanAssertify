...
// Getting value of variable: return_array_size_array
return_array_size_array = response_element_element;
if(return_array_size_array != null) {
return_array_size_array = return_array_size_array.length;
}
...
return_cca3 = response_element_element_element["cca3"];
...
return_maps_googleMaps = response_element_element_element["maps"];
...
console.log("Printing value of response_element_element_element_users_element");
console.log(response_element_element_element_users_element);

// Invariants of this nesting level:
// return.age >= 1
pm.test("return.age >= 1", () => {
// Getting value of variable: return_age
return_age = response_element_element_element_users_element["age"];
...
} // Closing for response_element_element_element
} // Closing if response_element_element_element

} // Closing if array nesting level 3
