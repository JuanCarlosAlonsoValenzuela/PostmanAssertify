...
return_links_size_array = response_items_element_artists_element_element["links"];
...
response_items_element_artists_element_element_links = response_items_element_artists_element_element["links"]
if(response_items_element_artists_element_element_links != null) {
// Printing value of response_items_element_artists_element_element_links variable
console.log("Printing value of response_items_element_artists_element_element_links");
console.log(response_items_element_artists_element_element_links);

for(response_items_element_artists_element_element_links_index in response_items_element_artists_element_element_links) {
response_items_element_artists_element_element_links_element = response_items_element_artists_element_element_links[response_items_element_artists_element_element_links_index]
// Printing value of response_items_element_artists_element_element_links_element variable
console.log("Printing value of response_items_element_artists_element_element_links_element");
console.log(response_items_element_artists_element_element_links_element);

// Invariants of this nesting level:
// return.available == true
pm.test("return.available == true", () => {
// Getting value of variable: return_available
return_available = response_items_element_artists_element_element_links_element["available"];
...
} // Closing for response_items_element_artists_element_element
} // Closing if response_items_element_artists_element_element
