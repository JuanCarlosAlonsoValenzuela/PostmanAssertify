...
// Getting value of variable: return_array_size_array
return_array_size_array = response_element;
if(return_array_size_array != null) {
return_array_size_array = return_array_size_array.length;
}
...
return_cca3 = response_element_element["cca3"];
...
return_maps_googleMaps = response_element_element["maps"];
...
// 200&users
response_element_element_users = response_element_element["users"]
if(response_element_element_users != null) {
// Printing value of response_element_element_users variable
console.log("Printing value of response_element_element_users");
console.log(response_element_element_users);

for(response_element_element_users_index in response_element_element_users) {
response_element_element_users_element = response_element_element_users[response_element_element_users_index]
// Printing value of response_element_element_users_element variable
console.log("Printing value of response_element_element_users_element");
console.log(response_element_element_users_element);

// Invariants of this nesting level:
// return.age >= 1
pm.test("return.age >= 1", () => {
// Getting value of variable: return_age
return_age = response_element_element_users_element["age"];
...
} // Closing for response_element_element
} // Closing if response_element_element
